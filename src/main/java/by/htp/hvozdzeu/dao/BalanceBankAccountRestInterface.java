...
public interface BalanceBankAccountRestInterface {
     ...
     */
    Response transferBalanceCardBankAccount(String tokenRest, String cardNumberFrom, String cardNumberTo,
     ...
     * @throws DAOException Exception
     */
    Response checkNewCreditCard(String tokenRest, String cardNumber, String cvCode,
